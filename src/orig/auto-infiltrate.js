...
function navigateAndInfiltrate() {
	ns.print("navigateAndInfiltrate");
	// Start the infiltration loop
	// while(true) {
		// Click "City"
		// svg[data-testid="LocationCityIcon"]
		var cityButton = document.querySelector('data-testid[value="LocationCityIcon"]');

		ns.print("cityButton click");
		...
		var eCorpButton = document.querySelector('aria-label[value="ECorp"]');

		ns.print("eCorpButton click");
		...
		// Click Infiltrate button
		var infiltrateButton = document.querySelector('input[value="Infiltrate Company"]');

		ns.print("infiltrateButton click");

		if (infiltrateButton) {
			infiltrateButton.click();
		}

		// <p class="MuiTypography-root MuiTypography-body1 css-cxl1tz">Aevum</p>
